...
export const WEAPON_REGISTRY: Record<string, FortniteWeapon> = {
  ...
  shotgun_tac_epic: {
    ...
    range: 25,
    pelletCount: 10,
    specialPerk: 'FAST-CYCLING BUCKSHOT: Continuous 1.5 RPS semi-auto fire with 8-shell tube capacity',
    color: '#a855f7',
    icon: '💥',
  },
  ...
  sniper_heavy_legendary: {
    ...
    specialPerk: 'BARRICADE BUSTER: Deals 1,000 Structure Damage & 300 Headshot Damage',
    color: '#f59e0b',
    icon: '🎯',
  },
